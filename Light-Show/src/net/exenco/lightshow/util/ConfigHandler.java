...
public class ConfigHandler {
    ...
    public static ItemStack getItemStackFromJsonObject(JsonObject jsonObject) {
        ...
        try {
            NBTTagCompound itemNbt = MojangsonParser.a(nbt);

            NBTTagCompound nbtTag = new NBTTagCompound();
            nbtTag.a("Count", count);
            nbtTag.a("id", item.toLowerCase());
            nbtTag.a("tag", itemNbt);
            return ItemStack.a(nbtTag);
    ...
    public static Material getMaterialFromName(String name) {
        ...
        nbtTagCompound.a("id", name.toLowerCase());
        nbtTagCompound.a("Count", 1);
        nbtTagCompound.a("tag", "{}");
        return CraftItemStack.asBukkitCopy(ItemStack.a(nbtTagCompound)).getType();
    }
}
